...
#### Linux:
Install qt6-base, download the [GearboxNext-linux.7z](https://github.com/Metvich/GearboxNext/releases/download/v1.0.1/GearboxNext-linux.7z) and unpack. Launch GearboxNext.

#### Windows:
Download the [GearboxNext-windows.7z](https://github.com/Metvich/GearboxNext/releases/download/v1.0.1/GearboxNext-windows.7z) and unpack. Launch GearboxNext.exe. If you are using Windows 11, run in Windows 8 compatibility mode.
...
2. Download from [qt6-base-windows](https://mirrors.tuna.tsinghua.edu.cn/qt/online/qtsdkrepository/windows_x86/desktop/qt6_690/qt6_690/qt.qt6.690.win64_msvc2022_64/6.9.0-0-202412120612qtbase-Windows-Windows_11_23H2-MSVC2022-Windows-Windows_11_23H2-X86_64.7z) and unpack.
